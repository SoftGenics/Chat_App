...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <ImageBackground
        source={{
          uri: 'https://img.freepik.com/free-photo/blank-speech-bubble-blue-background_23-2147910067.jpg?ga=GA1.1.121383371.1710929670&semt=ais_hybrid',
        }}
        style={{flex: 1}}>
          ...
          <View
            ...
            <View style={{marginTop: 10}}>
              <Pressable>
                ...
                />
                <Text style={{textAlign: 'center', marginTop: 5, color: 'black'}}>
                  Pushkar
                </Text>
              </Pressable>
            </View>
          ...
          {channels?.map((item, index) => (
            <View
              ...
              <View style={{flex: 1}}>
                ...
                <Text style={{marginTop: 4, color: 'black'}}>{item?.text}</Text>
              </View>
